...
(function () {
    ...
    Class.extend = function (f) {
        ...
        c = !1;
        for (var l in f)
            q[l] = "function" == typeof f[l] && "function" == typeof r[l] && g.test(f[l]) ? function (c, f) {
                return function () {
                    var g = this._super;
                    this._super = r[c];
...
(function (c, g) {
    ...
    var k = {"Add files": 0, "Start upload": 1, "Remove all": 2, Close: 3, "Select Files": 4, Preview: 5, "Remove file": 6, Bytes: 7, KB: 8, MB: 9, GB: 10, "Upload aborted": 11, "Upload all files": 12, "Select Files or Drag&Drop Files": 13, "File uploaded 100%": 14, "Max files number reached": 15, "Extension not allowed": 16, "File size now allowed": 17}, r = {it_IT: "Aggiungi file;Inizia caricamento;Rimuvi tutti;Chiudi;Seleziona;Anteprima;Rimuovi file;Bytes;KB;MB;GB;Interroto;Carica tutto;Seleziona o Trascina qui i file;File caricato 100%;Numero massimo di file superato;Estensione file non permessa;Dimensione file non permessa".split(";"), sq_AL: "Shto file;Fillo karikimin;Hiqi te gjith\u00eb;Mbyll;Zgjith filet;Miniatur\u00eb;Hiqe file-in;Bytes;KB;MB;GB;Karikimi u nd\u00ebrpre;Kariko t\u00eb gjith\u00eb;Zgjith ose Zvarrit dokumentat k\u00ebtu;File u karikua 100%".split(";"),
        ...
        fr_FR: "Ajouter;Envoyer;Tout supprimer;Fermer;Parcourir;Visualiser;Supprimer fichier;Bytes;Ko;Mo;Go;Envoi annul\u00e9;Tout envoyer;Parcourir ou Glisser/D\u00e9poser;Fichier envoy\u00e9 100%".split(";")}, q = {}, l = Class.extend({init: function (a, b, e, d, c) {
            this.file = a;
            this.status = 0;
            this.name = b;
            this.size = e;
            ...
            this.prevImage = c('<img class="ax-preview" src="" alt="' + f("Vista previa") + '" />').appendTo(this.prevContainer);
            ...
            this.uploadButton = c('<a title="' + f("Subir") +
                    '" class="ax-upload ax-button" />').appendTo(this.buttons).append('<span class="ax-upload-icon ax-icon"></span>');
            this.removeButton = c('<a title="Remover Archivo" class="ax-remove ax-button" />').appendTo(this.buttons).append('<span class="ax-clear-icon ax-icon"></span>');
                ...
                d.onload = function (d) {
                    e.css("cursor", "pointer").attr("src", d.target.result).click(function () {
                        var e =
                                new Image;
                        e.onload = function () {
                            var e = Math.min(c(window).width() / this.width, (c(window).height() - 100) / this.height), h = 1 > e ? this.width * e : this.width, e = 1 > e ? this.height * e : this.height, f = c(window).scrollTop() - 20 + (c(window).height() - e) / 2, g = (c(window).width() - h) / 2, f = c("#ax-box").css({top: f, height: e, width: h, left: g});
                ...
                if (4 == this.readyState && 200 == this.status)
                    try {
                        ...
                        if (-1 == parseInt(a.status))
                            throw a.info;
                        if (g)
                            n.onFinishUpload(a.name, a.size, a.status, a.info);
                        else
                            n.currentByte = f, n.uploadAjax()
                    } catch (b) {
                        n.onError(b)
                    }
            };
    ...
    t.prototype = {preCheckSettings: function (a) {
            ...
            var a = this.settings;
            this.mainWrapper = c('<div class="ax-main-container" />').append('<h5 class="ax-main-title">' + f("Seleccione el archivo PDF") + "</h5>").appendTo(this.container);
            ...
            this.browse_c = c('<a class="' + e + '" title="' + f("Seleccionar") + '" />').append('<span class="' + g + '"></span> <span class="ax-text">' + f("...") + "</span>").appendTo(this.mainWrapper);
            ...
            a.uploadDir && this.browseFiles.attr({directory: "directory", webkitdirectory: "webkitdirectory", mozdirectory: "mozdirectory"});
            ...
            this.uploadFiles = c('<a class="' + b + '" title="' + f("Subir Todos Los Archivos") + '" />').append('<span class="' + h + '"></span> <span class="ax-text">' + f("Subir Todos") + "</span>").appendTo(this.mainWrapper);
            this.removeFiles = c('<a class="' + d + '" title="' + f("Quitar Todos") + '" />').append('<span class="' + p + '"></span> <span class="ax-text">' + f("Quitar Todos") + "</span>").appendTo(this.mainWrapper);
            ...
            if (this.hasAjaxUpload) {
                ...
                "self" == a.dropArea && this.mainWrapper.find(".ax-main-title").html(f("Seleccione o Arrastre el archivo PDF"));
            ...
            this.settings.beforeSubmit.call(this, a, this.files, function () {
                if (null !== this.form && this.form !== g) {
                    for (var b = "function" == typeof this.settings.remotePath ? this.settings.remotePath() : this.settings.remotePath, c = 0; c < a.length; c++)
                        this.form.append('<input name="ax-uploaded-files[]" type="hidden" value="' + (b + a[c]) + '" />');
            ...
            if (!1 !== this.settings.beforeUploadAll.call(this, this.files))
                for (var a = this.getPendingFiles(), b = 0; b < a.length; b++)
                    a[b].startUpload()
        }, clearQueue: function () {
            ...
            if ("object" == typeof a)
                for (var g in a)
                    h.push(g + "=" + (c ? encodeURIComponent(a[g]) : a[g]));
            ...
            for (var c = [f("Bytes"), f("KB"), f("MB"), f("GB")], d = 0; 1024 <= a && d < c.length - 1; )
                a /= 1024, d++;
    ...
    var u = {remotePath: "uploads/", url: "upload.php", flash: "uploader.swf", data: "", async: !0, maxFiles: 9999, allowExt: [], success: function (a) {
        }, finish: function (a, b) {
        }, error: function (a, b) {
        }, enable: !0, chunkSize: 1048576, maxConnections: 3, dropColor: "red", dropClass: "ax-drop", dropArea: "self", autoStart: !1, thumbHeight: 0, thumbWidth: 0,
        thumbPostfix: "_thumb", thumbPath: "", thumbFormat: "", maxFileSize: "10M", form: null, hideUploadForm: !0, beforeSubmit: function (a, b, c) {
            c.call(this)
        }, editFilename: !1, beforeUpload: function (a, b) {
            return!0
        }, beforeUploadAll: function (a) {
            return!0
        }, onSelect: function (a) {
        }, onInit: function (a) {
        }, language: "auto", uploadDir: !1, removeOnSuccess: !1, removeOnError: !1, bootstrap: !1, previews: !0, validateFile: function (a, b, c) {
        }, overrideFile: !1, checkFileExists: !1, fileInfo: function (a) {
            var b = "", c;
            for (c in a)
                a.hasOwnProperty(c) && (b = "object" ==
                        typeof a[c] ? b + (c + " : [" + a[c].length + " values]\r\n") : b + (c + " : " + a[c] + "\r\n"));
            alert(b)
        }, allowDelete: !1}, s = {init: function (a) {
