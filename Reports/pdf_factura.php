...
$cns2 = $Set->lista_pagos_factura($id);
...
class PDF extends FPDF {
    ...
    function factura($cns, $emisor, $rst1, $cns1, $emisor_local, $cns2) {
        ...
        $this->MultiCell(85, 5, "Observaciones :  " . strtoupper(utf8_decode($rst1[fac_observaciones])), 'LR', 1);
        //______________________________________________________________________________________________________________
        $this->MultiCell(85, 5, "VENCIMIENTO", 'LR', 1);
        $n = 0;
...
if (isset($_GET[ide])) {
    $pdf->factura($cns, $emisor, $rst1, $cns1, $emisor_local, $cns2);
    $pdf->Output($rst1[fac_numero] . '.pdf', 'D');
} else {
    $pdf->factura($cns, $emisor, $rst1, $cns1, $emisor_local, $cns2);
