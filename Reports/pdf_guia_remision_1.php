...
$cns = $Set->lista_una_guia_id($id);
$rst = $Set->lista_una_guia_id($id);
$emi = pg_fetch_array($Set->lista_emisor($rst[emi_id]));
...
class PDF extends FPDF {
   ...
   function factura($rst, $cns, $emi) {
        ...
        $this->Cell(60, 5, "Fecha de Emision : " . $rst[gui_fecha_emision], 'TR', 0, 'L');
        $this->Ln();
        $this->SetFont('helvetica', 'B', 10);
...
//        ///////////////////////////////// ENCABEZADO INFERIOR IZQUIERDO ////////////////////////////////////////////////
        ...
        $this->Ln();
        $this->SetFont('helvetica', 'B', 8);
        $this->Cell(100, 9, "Direccion : " . utf8_decode($rst[gui_direccion]), 'LR');
        $this->Ln();
        $this->SetFont('helvetica', 'B', 8);
        $this->Cell(100, 9, "Telefono : " . utf8_decode($rst[gui_telefono]), 'LR');
        $this->Ln();
        $this->SetFont('helvetica', '', 8);
        $this->Cell(100, 9, "Email :  " . utf8_decode(strtolower($rst[gui_email])), 'LR', 0, 'L');
        $this->Ln();
        $this->SetFont('helvetica', '', 8);
