...
class PDF extends FPDF {
    ...
    function factura($rst, $cns, $emisor, $rst1, $g, $cns1, $rst2, $emisor_local) {
        ...
        $this->SetFont('helvetica', 'B', 10);
        $this->SetXY(115, 19);
        $this->Cell(88, 5, "  No.   " . $rst1[num_documento], 'LR');
        $this->Ln();
        $this->SetFont('helvetica', 'B', 10);
        $this->SetXY(115, 24);
        ...
        $this->SetFont('helvetica', 'B', 10);
        $this->SetXY(115, 29);
        $this->Cell(88, 5, $rst1[com_autorizacion], 'LR');
        $this->Ln();
        $this->SetFont('helvetica', 'B', 10);
        $this->SetXY(115, 34);
        ...
        $this->SetFont('helvetica', 'B', 10);
        $this->SetXY(115, 39);
        $this->Cell(88, 5, "AUTORIZACION : " . $rst1[fecha_hora_autorizacion], 'LR');
        $this->Ln();
        $this->SetFont('helvetica', 'B', 10);
        $this->SetXY(115, 44);
        ...
        $this->Ln($x + 4, $y + 1);
        $this->SetFont('helvetica', 'B', 8);
        $this->Cell(141, 5, "Razon Social / Nombres y Apellidos : " . $rst1[nombre], 'LT', 0, 'L');
        $this->SetFont('helvetica', 'B', 8);
        $this->Cell(55, 5, "Identificacion : " . $rst1[identificacion], 'RT', 'R');
        $this->Ln();
        $this->SetFont('helvetica', 'B', 8);
        $this->Cell(141, 5, "Fecha de Emision : " . $rst1[fecha_emision], 'LB', 0, 'L');
        $this->SetFont('helvetica', 'B', 8);
        ...
        while ($rst = pg_fetch_array($cns)) {
            ...
            $this->Cell(22, 4, $rst[cod_producto], 1, 0, 'C');
            $this->Cell(21, 4, $rst[cod_aux], 1, 0, 'C');
            $this->Cell(13, 4, $rst[cantidad], 1, 0, 'C');
            $this->Cell(80, 4, $rst[lote] . " " . substr($rst[descripcion], 0, 40), 1, 0, 'L');
            $this->Cell(20, 4, $rst[precio_unitario], 1, 0, 'R');
            $this->Cell(20, 4, $rst[descuento], 1, 0, 'R');
            $this->Cell(20, 4, $rst[precio_total], 1, 0, 'R');
            $this->Ln();
        }
        //___________________________________________________________________________
        $this->Cell(136, 5, "", '', 0, 'L');
        ...
        $this->Ln();
        $this->SetFont('helvetica', '', 8);
        $this->Cell(85, 5, "Vendedor: " . $rst1[vendedor], 'LR', 0, 'L');
        $this->Cell(51, 5, "", '', 0, 'L');
        $this->SetFont('helvetica', '', 8);
