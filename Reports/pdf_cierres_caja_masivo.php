...
class PDF extends FPDF {
    ...
    function cierre_caja($emisor, $user, $fec) {
        ...
        $this->SetFont('helvetica', '', 10);
        $this->Cell(28, 5, number_format($tot_caja, 4), 'LTB', 0, 'R', false);
        ...
        $this->SetFont('helvetica', '', 10);
        $this->Cell(24, 5, number_format($resul, 4), 'LTBR', 0, 'R', false);
        $this->Cell(24, 5, number_format($resul, 4), 'LTRB', 0, 'R', false);

        if (number_format($resul, 4) != number_format($resp, 4)) {
