...
function validaCampos(id)
{
  ...
  function(dt){
   id2=id.split('_');   
   camp=document.getElementById('ec_'+id2[1]).innerHTML="<option value=0>Seleccione</option>"+dt;    
  });       
        ...
        <tr>
            <?php
                ...
                while($n<count($data))
                {
                    ...
                    if( ($nm[1]=='a' || $nm[1]=='b' || $nm[1]=='c' || $nm[1]=='d' || $nm[1]=='e' || $nm[1]=='f') && ($_SESSION['usuid']!=1) )
                    {
                        $readOnly="readOnly";
                    }else{
                        $readOnly="";
                    ...
                    ?>
                        ...
                        <table class="submenu" id="<?php echo 'tbl_'.$n?>" cellpadding="2"  >
                            ...
                            <tr>
                                ...
                                <td>
                                    <select title="Tabla de Enlace" class="<?php echo "clase"?>" id="<?php echo 'et_'.$n?>"  onchange="validaCampos(this.id)" >
                                        ...
                                        <option value="erp_sn1">Sn1</option>                                        
                            ...
                            <tr>
                              ...
                              <input class="<?php echo "clase"?>" <?php echo $readOnly;?> id="<?php echo 'txt_'.$n?>" name="<?php echo $data[$n]?>"  type="text" value="<?php echo $value[9]?>" size="50" />                              
                                <?php 
                                    if($nm[1]!='tipo')
                                    {
                                     ?>
