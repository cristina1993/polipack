...
//                            cancelar();
                            ...
                            $('#ord_peso').attr('readonly', true);
                            $('#cal_rollo').attr('readonly', true);
                            $('#pes_conforme').attr('readonly', true);
            ...
            function load_semielaborado(obj) {
                ...
                function (dt) {
                    ...
                    if (dat[0] != '') {
                        ...
                        $('#ord_peso').attr('readonly', false);
                        $('#cal_rollo').attr('readonly', false);
                        $('#pes_conforme').attr('readonly', false);
                        calcular();
                    } else {
                    ...
                    <td style="height: 200px">
                        <table >
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" size="15" readonly id="ord_peso" value="0" onchange="calcular()" onkeyup="this.value = this.value.replace(/[^0-9.]/, '');"/>
                            ...
                            <tr>
                                <td>#Rollos</td> 
                                <td>
                                    <input type="text" size="12" readonly id="cal_rollo" value="0" onchange="calculo_peso()" onkeyup="this.value = this.value.replace(/[^0-9.]/, '');" />
                                </td>  
                                <td>Peso Conforme</td> 
                                <td>
                                    <input type="text" size="12" readonly id="pes_conforme" value="0" onkeyup="this.value = this.value.replace(/[^0-9.]/, '');"/>
