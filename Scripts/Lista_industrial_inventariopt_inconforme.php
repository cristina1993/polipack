...
include_once '../Clases/clsClase_industrial_inventariopt_inconforme.php'; //cambiar clsClase_productos
$Clase_industrial_inventariopt = new Clase_industrial_inventariopt_inconforme();
    ...
    <body>
        ...
        <table style="width:100%" id="tbl">
            <caption  class="tbl_head">
                ...
                <center class="cont_title" ><?PHP echo 'INVENTARIO INCONFORME DE PRODUCTO TERMINADO ' ?></center>
