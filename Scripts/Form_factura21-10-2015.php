            ...
            <table id="tbl_form" border="1">
                ...
                <tr><td><table id='tbl_colum2' border="0" ><tr class="trthead"><td  colspan="2" style="background:#00557F ;color:white " align='center' ><label class="tdtitulo">CLIENTE:</label></td></tr>
                            <tr>
                                ...
                                <td><input type="text" size="45"  id="identificacion" value="<?php echo $rst[fac_identificacion] ?>" onchange="load_cliente(this)"  maxlength="13" <?php echo $read ?>/>
...
while ($rst_pro = pg_fetch_array($cns_pro)) {
    $x++;
    echo "<option value='$rst_pro[tbl]$rst_pro[id]' label='$rst_pro[lote] $rst_pro[codigo] $rst_pro[descripcion]' />";
}
echo "</datalist>";
?>
<script>
