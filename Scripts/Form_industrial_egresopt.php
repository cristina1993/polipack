        ...
        <script>
            ...
            function save(id, x) {
                ...
                $.ajax({
                    ...
                    type: 'POST',
                    url: 'actions_industrial_egresopt.php',
                    data: {op: 0, 'data[]': data, 'fields[]': fields, id: id, x: 1}, //op sera de acuerdo a la acion que le toque
                    success: function (dt) {
                        if (dt == 0) {
                            loading('hidden');
                            imprimir();
             ...
             function cancelar() {
                ...
                parent.document.getElementById('bottomFrame').src = '../Scripts/Lista_industrial_egresopt.php?fecha1=' + mov_fecha_trans.value + '&fecha2=' + mov_fecha_trans.value;//Cambiar Form_productos
...
//                }
                ...
                $.post("actions_industrial_egresopt.php", {op: 1, id: vl, lt: lt},
                function (dt) {
                    dat = dt.split('&');
                    if (dat[0] != '') {
        ...
        <form  autocomplete="off" id="frm_save" lang="0">
            <table id="tbl_form">
                <thead>
                    ...
                    <tr>
                        <th colspan="7" ><?PHP echo 'EGRESO DE PRODUCTO TERMINADO' ?>
                        ...
                        <table>
                            <tbody id="encabezado">
                                ...
                                <tr>
                                    ...
                                    <td> <select id="trs_id" style="width:200px; " onchange="seleccion()" disabled>
                                            <?php
...
<datalist id="lotes">
    <?php
//    $cns_lotes= $Clase_industrial_egresopt->lista_lotes_todos();
//    while ($rst_lt= pg_fetch_array($cns_lotes)) {
    ?>
        <!--<option value="<?php echo $rst_lt[mov_pago] ?>"><?php echo $rst_lt[mov_pago] ?></option>-->
    <?php
//    }
    ?>
</datalist>
...
<datalist id="ordenes">
    <?php
    $cns_ord = $Clase_industrial_egresopt->lista_ordenes();
    $n = 0;
