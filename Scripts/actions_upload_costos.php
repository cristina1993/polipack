    ...
    while (!feof($file)) {
        ...
        if ($n > 0) {
            ...
            if (strlen(trim($row[0])) > 0) {
                if (!$Pre->upd_costos($data, $pre_id)) {
                    $err;
                    echo "<script>
                                   alert('$err Linea $n')
                                   parent.document.getElementById('bottomFrame').src = ''
                                   parent.document.getElementById('contenedor2').rows = '*,0%'
                                   parent.document.getElementById('mainFrame').src = '../Scripts/Lista_costos.php'
                           </script>                        
                        ";
                    break;
                }
        ...
        if ($n > 1) {
            ...
            if (strlen(trim($row[0]))) {
                ...
                if ($vl == 1) {
                    ...
                    if (is_numeric(round($row[3],4))) {
                        
                    } else {
                        $sms = "<script>
                                   alert('El campo Costo1 no es un valor numerico linea  $n ')
                                   parent.document.getElementById('bottomFrame').src = ''
                                   parent.document.getElementById('contenedor2').rows = '*,0%'
                                   parent.document.getElementById('mainFrame').src = '../Scripts/Lista_costos.php'
                           </script>                        
                    ...
                    if (is_numeric(round($row[4],4))) {
                        
                    } else {
                        $sms = "<script>
                                   alert('El campo Costo2 no es un valor numerico linea  $n ')
                                   parent.document.getElementById('bottomFrame').src = ''
                                   parent.document.getElementById('contenedor2').rows = '*,0%'
                                   parent.document.getElementById('mainFrame').src = '../Scripts/Lista_costos.php'
                           </script>                        
