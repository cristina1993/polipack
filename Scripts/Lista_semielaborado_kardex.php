...
if (isset($_GET[txt], $_GET[prod], $_GET[fecha1], $_GET[fecha2])) {
    ...
    if (!empty($nm)) {
        ...
        $txt = "and (p.pro_codigo like '%$prod%' or p.pro_descripcion like '%$prod%' or m.mov_pago like '%$prod%') and m.mov_fecha_trans between '$fec1' and '$fec2'";
    } else {
...
<html> 
    ...
    <body>
        <table style="display:none" border="1" id="tbl2">
            ...
            <tr><td colspan="13" align="center"><?PHP echo 'KARDEX DE PRODUCTO PERCHA' ?></td></tr>
            <tr>
        ...
        <table style="width:100%" id="tbl">
            <caption  class="tbl_head">
                ...
                <center class="cont_title" ><?PHP echo 'KARDEX DE PRODUCTO PERCHA' ?></center>
