    ...
    <head>
        <script>
            ...
            function auxWindow(a, id, x, e)
            {
                ...
                {
                    case 0://Nuevo
                        frm.src = '../Scripts/Form_registro_nota_credito.php';//Cambiar Form_productos
                        parent.document.getElementById('contenedor2').rows = "*,80%";
                        break;
                    case 1://Editar
                        parent.document.getElementById('contenedor2').rows = "*,80%";
                        frm.src = '../Scripts/Form_registro_nota_credito.php?id=' + id;//Cambiar Form_productos
                        look_menu();
                        break;
                    case 2://Reporte
                        parent.document.getElementById('contenedor2').rows = "*,80%";
    ...
    <body>
        ...
        <tbody id="tbody">
            ...
            while ($rst = pg_fetch_array($cns)) {
                ...
                $c = '"';
//                <td align='center'>
//                    <img class='auxBtn' width='12px' src='../img/del_reg.png' onclick='del($rst[rnc_id],$c$rst[rnc_num_registro]$c,$c$rst[rnc_numero]$c)'>
//                    <img src='../img/upd.png' class='auxBtn' width='16px' onclick='auxWindow(1, $rst[rnc_id])'>   
//                    </td>
                $ev = "onclick='auxWindow(1,$rst[rnc_id])'";
                echo "<tr>
                    <td $ev>$n </td>
