...
//                i = $('.itm').length;
                ...
                if (emi != 1 && emi != 10) {
                    ...
                    if (tipo_pago1.checked == true) {
                        a = 1;
                    } else {
                        a = 0;
                    }
                    if (tipo_pago2.checked == true) {
                        b = 2;
                    } else {
                        b = 0;
                    }
                    if (tipo_pago3.checked == true) {
                        c = 3;
                    } else {
                        c = 0;
                    }
                    if (tipo_pago4.checked == true) {
                        d = 4;
                    } else {
                        d = 0;
                    }
                    if (tipo_pago5.checked == true) {
                        e = 5;
                    ...
                    if (tipo_pago6.checked == true) {
                        f = 6;
                    } else {
                        f = 0;
                    }
                    if (tipo_pago7.checked == true) {
                        g = 7;
                    } else {
                        g = 0;
                    }
                    if (tipo_pago8.checked == true) {
                        h = 8;
                    } else {
                        h = 0;
                    }
                    tipo_pago = a + ',' + b + ',' + c + ',' + d + ',' + e + ',' + f + ',' + g + ',' + h;
                    var data3 = Array();
                    data3.push(
                            emi + '&' +
                            tipo_pago
...
//                        doc = document.getElementsByClassName('itm');
            ...
            function load_producto(obj) {
                ...
                function (dt) {
                    ...
                    $('#descuento' + obj.lang).val(0);
                    $('#descuent' + obj.lang).val(0);
                    $('#pro_aux' + obj.lang).val(dat[6]);
                    $('#lote' + obj.lang).val(dat[7]);
                    if (dat[3] == '') {
            ...
            <table id="tbl_form" border="1">
                ...
                <tr><td><table id='tbl_colum2' border="0" ><tr class="trthead"><td  colspan="2" style="background:#00557F ;color:white " align='center' ><label class="tdtitulo">CLIENTE:</label></td></tr>
                            <tr>
                                ...
                                <td><input type="text" size="62"  id="identificacion" value="<?php echo $rst['identificacion'] ?>" onchange="load_cliente(this)"  /></td>
                            </tr>
                            <tr>
                                <td>NOMBRE:</td>
                                <td><input type="text"  size="62" id="nombre"  value="<?php echo $rst['nombre'] ?>"  /></td>
                            </tr>
                            <tr>
                                <td>DIRECCION:</td>
                                <td><input type="text"  size="62" id="direccion_cliente"  value="<?php echo $rst['direccion_cliente'] ?>"  /></td>
                            </tr>
                            <tr>
                                <td>TELEFONO:</td>
                                <td><input type="text"   size="62"  id="telefono_cliente"  value="<?php echo $rst['telefono_cliente'] ?>"  /></td>
                            </tr>
                            <tr>
                                <td>EMAIL:</td>
                                <td><input type="text" style="text-transform:lowercase "  size="62"  id="email_cliente"  value="<?php echo $rst['email_cliente'] ?>"  /></td>
                            </tr>
                            <tr>
                                <td>PARROQUIA:</td>
                                <td><input type="text"  size="62"  id="cli_parroquia"  value="<?php echo $rst['cli_parroquia'] ?>"  /></td>
                            </tr>
                            <tr>
                                <td>CIUDAD:</td>
                                <td><input type="text"  size="62"  id="cli_ciudad"  value="<?php echo $rst['cli_ciudad'] ?>"  /></td>
                            </tr>
                            <tr>
                                <td>PAIS:</td>
                                <td><input type="text"  size="62"  id="cli_pais"  value="<?php echo $rst['cli_pais'] ?>"  /></td>
                            </tr></table></td>
                    <td valign="top">
                        <table width='100%' id='tbl_colum3' border="0">
                            ...
                            ?>
                                ...
                                ?>
                                <tr>
                                    <td><input type="checkbox" id="tipo_pago1" name="tipo_pago" value="1"/>Tarjeta credito</td>
                                </tr>
                                <td><input type="checkbox" id="tipo_pago2" name="tipo_pago" value="2" />Tarjeta debito</td>
                                <tr>
                                    <td><input type="checkbox" id="tipo_pago3" name="tipo_pago" value="3" />Cheque</td>
                                </tr>
                                <td><input type="checkbox" id="tipo_pago4" name="tipo_pago" value="4" />Efectivo</td>
                                <tr>
                                    <td><input type="checkbox" id="tipo_pago5" name="tipo_pago" value="5" />Certificado (Bono)</td>
                                </tr>
                                <td><input type="checkbox" id="tipo_pago6" name="tipo_pago" value="6" />Bonos</td>
                                <tr>
                                    <td><input type="checkbox" id="tipo_pago7" name="tipo_pago" value="7" />Retencion</td>
                                </tr>
                                <td><input type="checkbox" id="tipo_pago8" name="tipo_pago" value="8" />Nota de Credito</td>
    <!--                                <tr>
                                    <td>Vendedor:
                                        <input type="text" size="" id="" /></td>
                                </tr>-->
                                <?php
                            }
                            ?>
                ...
                <tr><td colspan="2">
                        <table  id="tbl_dinamic" lang="0">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <tr>
                                        ...
                                        if ($emisor == 1) {
                                            ?>
                                            <td><input type="text" size="70" id="pro_descripcion1" value="" lang="1" list="productos"
                                                       onblur="load_producto(this)"/></td>
                                                <?php
                                        ...
                                        <td><input type ="text" size="70"  id="pro_referencia1"  value="" lang="1" readonly/><input type="text" size="35" id="pro_aux1" hidden lang="1" /></td>
                                    ...
                                    while ($rst_det = pg_fetch_array($cns_det)) {
                                        ...
                                        <tr>
                                            ...
                                            <td><input type ="text" size="40"  id="<?php echo 'pro_referencia' . $n ?>"  value="<?php echo $rst_det['descripcion'] ?>" lang="<?PHP echo $n ?>" readonly/><input type="text" size="35" id="pro_aux<?PHP echo $n ?>" hidden <?PHP echo $n ?> value="<?php echo $rst_det['cod_aux'] ?>"/></td>
                            ...
                            <tfoot>
                                ...
                                <tr>
                                    <td colspan="7" align="right">Sub Total no objeto de Iva:</td>
                                ...
                                <tr>
                                    <td colspan="7" align="right">Total Valor:</td>
...
<datalist id="productos"  style="width: 800px;">
    <?php
    if ($emisor == 1) {
