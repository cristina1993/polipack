...
//                    $salp = ($rst[ped_det_peso] - $rst_egr[peso]);
                    ...
                    <tr>
                        ...
                        <td align="right"><input type="text" size="5" readonly id="<?php echo "sol" . $n . $rst_h[ped_orden] ?>" value="<?php echo str_replace(',', '', number_format($rst[ped_det_cant], 1)) ?>" /></td>
                        ...
                        <td align="right"><input type="text" size="5" id="<?php echo "ent" . $n . $rst_h[ped_orden] ?>" readonly value="<?php echo str_replace(',', '', number_format($rst_egr[unidad], 1)) ?>" /></td>
                        ...
                        <!--<td align="center"></td>-->
                        <td>
                            <img src="../img/save.png" class="auxBtn" onclick="save(<?php echo $rst[mp_id] ?>, '<?php echo $rst_h[ped_orden] ?>', '<?php echo "cn" . $n . $rst_h[ped_orden] ?>', '<?php echo $rst[mp_presentacion] ?>', '<?php echo "ps" . $n . $rst_h[ped_orden] ?>', '<?php echo "su" . $n . $rst_h[ped_orden] ?>', '<?php echo $inv_u ?>',<?php echo $n ?>, '<?php echo "sol" . $n . $rst_h[ped_orden] ?>', '<?php echo "ent" . $n . $rst_h[ped_orden] ?>')">
                        </td>
                    </tr>
                    <?php
                }
