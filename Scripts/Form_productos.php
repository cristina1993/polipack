    ...
    <head>
        <script>
            ...
            function insert_precios() {
                $.post("actions_preciospt.php", {op: 3, tab: 1},
                function (dt) {
                    if (dt == 0)
                    {
                        loading('hidden');
            ...
            {
                window.location = 'Form_productos.php?tipo=' + tipo;
            }
    ...
    <body>
        ...
        <table id="tbl_form" border="0" cellspacing='0' cellpadding='0' >
            <thead>
                <tr>
                    <th colspan="3" >
                        <select style="width:200px;float:left  " name="tipo" id="tipo" onchange="loadData(this.value)">
            ...
            <tr>
                <td id="head" colspan="3" valign="top" align="left">
                    <table id="tbl_head" border="0" cellspacing='0' cellpadding='0' >
                        <tr>
                            <?php
                            $n = 2;
                            while ($n <= count($files)) {
                        ...
                        while ($n <= count($files)) {
                            ...
                            if ($file[0] == 'I' && !empty($file[9])) {
                                ...
                                <tr>
                                    ...
                                    <td><input class='elemento' type="text" lang="1"  id="<?php echo $file[8] . '1' ?>" size="2" value="<?php echo $data[$file[8] . '1'] ?>" /></td>
                                    <td><input class='elemento' type="text" lang="1" id="<?php echo $file[8] . '2' ?>" size="2" value="<?php echo $data[$file[8] . '2'] ?>" /></td>
                                    <td><input class='elemento' type="text" lang="1" id="<?php echo $file[8] . '3' ?>" size="2" value="<?php echo $data[$file[8] . '3'] ?>" /></td>
                                    <td><input class='elemento' type="text" lang="1" id="<?php echo $file[8] . '4' ?>" size="2" value="<?php echo $data[$file[8] . '4'] ?>" /></td>
                                </tr>                                            
                                <?php
                            }
                            $n++;
