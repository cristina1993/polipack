...
if (isset($_GET[search])) {
    ...
    if ($fml == 'x') {
        ...
        $fml = "";
        $cns_data = $Rep->lista_reporte_productos_locales($txt, $fml, $d, $h);
    } else {
        $txt = "";
        ...
        <table  id="tbl">
            ...
            <thead>
                <tr>
                    ...
                    while ($rst_locales = pg_fetch_array($cns)) {
                        echo "<th colspan='2' class='locales' lang='$rst_locales[cod_punto_emision]'>$rst_locales[nombre_comercial]</th>";
                    }
                    ?>
            ...
            <tbody>
                ...
                while ($rst = pg_fetch_array($cns_data)) {
                    ...
                    if ($fml != $rst[familia]) {
                        ...
                        echo "<tr>
                            <td class='familias' lang='$rst[ids]' colspan='35'>$rst[familia]</td>
                        </tr>";
                    }
            ...
            <script>
                $('.row').each(function () {
                    ...
                    v1 = $(this).find('.vlr1').html().replace(/,/g, '');
                    v2 = $(this).find('.vlr2').html().replace(/,/g, '');
                    v3 = $(this).find('.vlr3').html().replace(/,/g, '');
                    v4 = $(this).find('.vlr4').html().replace(/,/g, '');
                    v5 = $(this).find('.vlr5').html().replace(/,/g, '');
                    v6 = $(this).find('.vlr6').html().replace(/,/g, '');
                    v7 = $(this).find('.vlr7').html().replace(/,/g, '');
                    v8 = $(this).find('.vlr8').html().replace(/,/g, '');
                    v9 = $(this).find('.vlr9').html().replace(/,/g, '');
                    v10 = $(this).find('.vlr10').html().replace(/,/g, '');
                    v11 = $(this).find('.vlr11').html().replace(/,/g, '');
                    v12 = $(this).find('.vlr12').html().replace(/,/g, '');
                    v13 = $(this).find('.vlr13').html().replace(/,/g, '');
                    v14 = $(this).find('.vlr14').html().replace(/,/g, '');
                    tot_val = (v1 * 1 + v2 * 1 + v3 * 1 + v4 * 1 + v5 * 1 + v6 * 1 + v7 * 1 + v8 * 1 + v9 * 1 + v10 * 1 + v11 * 1 + v12 * 1 + v13 * 1 + v14 * 1);

                    $(this).append("<td align='right' name='cn" + this.lang + "20' class='cnt20' >" + accounting.formatMoney(t_v, "", 0, ",", ".") + "</td><td align='right' name='vl" + this.lang + "20' class='vlr20' >" + accounting.formatMoney(tot_val, "", 4, ",", ".") + "</td>");
                });
            </script>
            ...
            <script>
                $('.familias').each(function () {
                    ...
                    $('.locales').each(function () {
                        ...
                        $("#" + fml).append("<td align='right'>" + accounting.formatMoney(tcn, "", 0, ",", ".") + "</td><td align='right' >" + accounting.formatMoney(tvl, "", 4, ",", ".") + "</td>").html();
                    });
                });
