...
$cns_combomp9 = $Set->lista_combo_empa_core2('27', '26'); ///des 1
$cns_combomp10 = $Set->lista_combo_empa_core2('27', '26'); ///des 2
$cns_combomp11 = $Set->lista_combo_empa_core2('27', '26'); ///des 3
$cns_combomp12 = $Set->lista_combo_empa_core2('27', '26'); ///des 4
$cns_combomp13 = $Set->lista_combo_empa_core('26'); ///EMPA
$cns_combomp14 = $Set->lista_combo_empa_core('27'); ///core
$cns_combomp15 = $Set->lista_combo_empa_core2('27', '26'); ///des 1
$cns_combomp16 = $Set->lista_combo_empa_core2('27', '26'); ///des 2
$cns_combomp17 = $Set->lista_combo_empa_core2('27', '26'); ///des 3
$cns_combomp18 = $Set->lista_combo_empa_core2('27', '26'); ///des 4
$cns_combomp19 = $Set->lista_combo_empa_core('26'); ///EMPA
$cns_combomp20 = $Set->lista_combo_empa_core('27'); ///core
$cns_combomp21 = $Set->lista_combo_empa_core2('27', '26'); ///des 1
$cns_combomp22 = $Set->lista_combo_empa_core2('27', '26'); ///des 2
$cns_combomp23 = $Set->lista_combo_empa_core2('27', '26'); ///des 3
$cns_combomp24 = $Set->lista_combo_empa_core2('27', '26'); ///des 4
$nombre = 'POLIPACK';
$cli_id = '1';
if (isset($_GET [id])) {
    ...
    if (isset($_GET[prod])) {
        ...
        $det_id = $_GET[prod];
        $ped_id = $rs_pv[ped_id];
        $rst[ord_observaciones] = $rs_pv[det_observacion];
        $cli_id = $rs_pv[cli_id];
...
//                document.getElementById("ord_pro_principal").disabled = true;
            ...
            function save(id)
            {
                ...
                } else if (ord_eti_numero.value.length == 0) {
                    ord_eti_numero.focus();
                    ord_eti_numero.style.borderColor = "red";
                } else {
                    if ($('#tr_frente').attr('checked') == true) {
                        trat = 0;
                    } else if ($('#tr_reverso').attr('checked') == true) {
                        trat = 1;
                    } else if ($('#tr_ninguno').attr('checked') == true) {
                        trat = 2;
                    } else if ($('#tr_ambos').attr('checked') == true) {
                        trat = 3;
                    }
                    var data = Array(
                            ord_num_orden.value,
                            ...
                            mp_cnt7.value,///opp_kg7
                            mp_cnt8.value,///opp_kg8
                            mp_cnt9.value,///opp_kg9
                            mp_cnt10.value,///opp_kg10
                            mp_cnt11.value,///opp_kg11
                            mp_cnt12.value,///opp_kg12
                            mp_cnt13.value,///opp_kg13
                            mp_cnt14.value,///opp_kg14
                            mp_cnt15.value,///opp_kg15
                            mp_cnt16.value,///opp_kg16
                            mp_cnt17.value,///opp_kg17
                            mp_cnt18.value,///opp_kg18
                            mp_cnt19.value,///opp_kg19
                            mp_cnt20.value,///opp_kg20
                            mp_cnt21.value,///opp_kg21
                            mp_cnt22.value,///opp_kg22
                            mp_cnt23.value,///opp_kg23
                            mp_cnt24.value,///opp_kg24
                            opp_velocidad.value,
...
//                kgtotal = (totpeso * rollos_madre_prod).toFixed(2);
                ...
                merma = parseFloat($('#ord_merma').val()) / 100;
                if ($('#ord_merma').val().length == 0) {
                    merma = 0;
                }
                ...
                while (n < 6) {
                    ...
                    ord = $('#ord_mf' + n).val();
                    if (ord != "" && ord != 0) {
                        kg = (((kgtotal1 * ord) / 100) * merma) + ((kgtotal1 * ord) / 100);
                ...
                while (n < 12) {
                    ...
                    ord = $('#ord_mf' + n).val();
                    if (ord != "" && ord != 0) {
                        kg = (((kgtotal2 * ord) / 100) * merma) + ((kgtotal2 * ord) / 100);
                        $('#ord_kg' + n).val(kg.toFixed(2));
                    } else {
                        $('#ord_kg' + n).val('0.00');
                    }
                ...
                while (n < 18) {
                    ...
                    ord = $('#ord_mf' + n).val();
                    if (ord != "" && ord != 0) {
                        kg = (((kgtotal3 * ord) / 100) * merma) + ((kgtotal3 * ord) / 100);
                        $('#ord_kg' + n).val(kg.toFixed(2));
                    } else {
                        $('#ord_kg' + n).val('0.00');
                    }
                ...
                <td colspan="10">
                    <table colspan="10">
                        <tr>
                            ...
                            <td>#Etiqueta:</td>
                            <td><input type="number" min="1" style="width: 50px" id="ord_eti_numero" value="<?php echo $rst[ord_eti_numero] ?>"/></td>
                        </tr>
                        <tr>
                            <td>&nbsp;</td>
                        </tr>
...
<!--<td><select name="ord_pro_secundario" id="ord_pro_secundario" style="width:182px" onchange="despliegue_ancho_producto_secundario(ord_pro_secundario.value)" ></select></td>-->
                        ...
                        <tr>
                            ...
                            <td colspan="4">Tratado: 
                                <input type="radio" name="tratado" id="tr_frente"/>Frente
                                <input type="radio" name="tratado" id="tr_reverso"/>Reverso
                                <input type="radio" name="tratado" id="tr_ninguno" />Ninguno
                                <input type="radio" name="tratado" id="tr_ambos"/>Ambos
                            </td>
                        </tr>
...
<script>
    ...
    $('#ord_etiqueta').val(et);
    var trat = '<?php echo $rst[ord_tratado] ?>';
    if (trat == 0) {
        $('#tr_frente').attr('checked', true);
    } else if (trat == 1) {
        $('#tr_reverso').attr('checked', true);
    } else if (trat == 2) {
        $('#tr_ninguno').attr('checked', true);
    } else if (trat == 3) {
        $('#tr_ambos').attr('checked', true);
    }
</script>