...
//                            loading('hidden');
            ...
            function load_orden(op,datos) {
                ...
                if (op == 1) {
//                    var data=array(ord,pro, peso, lt,  std);
                    auxWindow(0,datos);
                }
            }
...
//            }
            ...
            function auxWindow(a, datos) {
                switch (a) {
                    case 0:
//                        wnd = "<iframe id='frmmodal' width='" + boxW + "' height='" + boxHF + "' src='../Reports/pdf_etiq_reg_extrusion.php?pro_id=" + pro + "&peso=" + peso + "&lote=" + lt + "&orden=" + ord + "&std=" + std + "&mod=" + mod+ "' frameborder='0' />";
                        wnd = "<iframe id='frmmodal' width='" + boxW + "' height='" + boxHF + "' src='../Reports/pdf_etiq_reg_extrusion.php?data=" + datos + "&mod="+mod+"' frameborder='0' />";
                        break;
                }
    ...
    <body>
        ...
        <form  autocomplete="off" id="frm_save" lang="0">
            <table id="tbl_form">
                <thead>
                    <tr><th colspan="9" >REGISTRO DE PRODUCCION CAST  <font class="cerrar"  onclick="cancelar()" title="Salir del Formulario">&#X00d7;</font></th></tr>
                </thead>
                <tr>
                    <td>
                        <table>
                            ...
                            <tr>
                                <td>ORDEN#:</td>
                                <td>
                                    <input type="text" size="15" id="ord_numero" value="<?php echo $rst[ord_num_orden] ?>" onchange="load_orden(this)" list="ordenes"/>
                    ...
                    <td id="formula" rowspan="3">
                        <table>
                            ...
                            <tr>
                                <td>Extrusora B: </td>
                                <td><input readonly  onkeyup="this.value = this.value.replace(/[^0-9.]/, '');" onchange="validacion(this)" type="text" name="ord_por_tornillo1" id="ord_por_tornillo1" size="7" style="text-align:right"  value="<?php echo $rst[ord_por_tornillo1] ?>" /> %</td>
                            </tr>
                            <tr>
                                <td>
                                    <select disabled name="ord_mp1" id="ord_mp1"style="width:180px">
                                    </select>
                                </td>
                                <td hidden>
                            ...
                            <tr>
                                <td>
                                    <select disabled name="ord_mp2" id="ord_mp2" style="width:180px">
                                    </select>
                                </td>
                                <td hidden>
                            ...
                            <tr>
                                <td>
                                    <select disabled name="ord_mp3" id="ord_mp3" style="width:180px">
                            ...
                            <tr>        
                                <td>
                                    <select disabled name="ord_mp4" id="ord_mp4" style="width:180px">
                                    </select>
                                </td>
                                <td hidden>
                            ...
                            <tr>        
                                <td>
                                    <select disabled name="ord_mp5" id="ord_mp5" style="width:180px">
                                    </select>
                                </td>
                                <td hidden>
                            ...
                            <tr>        
                                <td>
                                    <select disabled name="ord_mp6" id="ord_mp6" style="width:180px">
                            ...
                            <tr>
                                <td>
                                    <select disabled name="ord_mp7" id="ord_mp7"style="width:180px">
                                    </select>
                                </td>
                                <td hidden>
                            ...
                            <tr>
                                <td>
                                    <select disabled name="ord_mp8" id="ord_mp8" style="width:180px">
                            ...
                            <tr>
                                <td>
                                    <select disabled name="ord_mp9" id="ord_mp9" style="width:180px">
                            ...
                            <tr>
                                <td>
                                    <select disabled name="ord_mp10" id="ord_mp10" style="width:180px">
                            ...
                            <tr>
                                <td>
                                    <select disabled name="ord_mp11" id="ord_mp11" style="width:180px">
                            ...
                            <tr>
                                <td>
                                    <select disabled name="ord_mp12" id="ord_mp12" style="width:180px">
                            ...
                            <tr>
                                <td>
                                    <select disabled name="ord_mp13" id="ord_mp13"style="width:180px">
                                    </select>
                                </td>
                                <td hidden>
                            ...
                            <tr>
                                <td>
                                    <select disabled name="ord_mp14" id="ord_mp14" style="width:180px">
                            ...
                            <tr>
                                <td>
                                    <select disabled name="ord_mp15" id="ord_mp15" style="width:180px">
                            ...
                            <tr>
                                <td>
                                    <select disabled name="ord_mp16" id="ord_mp16" style="width:180px">
                            ...
                            <tr>
                                <td>              
                                    <select disabled name="ord_mp17" id="ord_mp17" style="width:180px">
                            ...
                            <tr>
                                <td>
                                    <select disabled name="ord_mp18" id="ord_mp18" style="width:180px">
                            ...
                            <tr>
                                <td colspan="3">Observaciones:
                                    <textarea name="rec_observaciones" id="rec_observaciones" style="width:100%"><?php echo $rst[rec_observaciones] ?></textarea></td>
                            </tr>
                        </table>
                    </td>
                </tr>
