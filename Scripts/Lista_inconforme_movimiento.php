...
if (isset($_GET[fecha1], $_GET[fecha2])) {
    ...
    $fec2 = $_GET[fecha2];
    if (!empty($prod)) {
        $txt = " and (pro_codigo like '%$prod%' or pro_descripcion like '%$prod%') and m.mov_fecha_trans between '$fec1' and '$fec2'";
    } else if (!empty($txt)) {
    ...
    <body>
        ...
        <table style="width:100%" id="tbl">
            <caption  class="tbl_head">
                ...
                <center class="cont_title" ><?PHP echo 'MOVIMIENTO DE PRODUCTO SEMIELABORADO INCONFORME'?> </center>
