...
include_once '../Clases/clsClase_inconfome_movimiento.php';
$Set = new Clase_inconforme_movimiento();
$id = 0;
...
<html>
    <head>
        ...
        <script>
            ...
            function load_producto_lote(obj) {
                j = obj.lang;
                vl = $('#pro_id' + j).val();
                lt = $('#lote' + j).val().trim();
                $('.itm').each(function () {
        ...
        <form  autocomplete="off" id="frm_save" lang="0">
            <table id="tbl_form">
                <thead>
                    ...
                    <tr>
                        <th colspan="7" ><?PHP echo 'MOVIMIENTO DE PRODUCTO SEMIELABORADO INCONFOME' ?>
                ...
                <tr>
                    ...
                    <td><input type ="text" size="15"  id="lote1"  value="" lang="1" maxlength="11" onchange="load_producto_lote(this)"/></td>
