...
if (isset($_GET[txt], $_GET[fecha2])) {
    ...
    $fec2 = $_GET[fecha2];
    if (!empty($nm)) {
        $txt = "and (pro_codigo like '%$nm%' or pro_descripcion like '%$nm%') and m.mov_fecha_trans between '1900-01-01' and '$fec2'";
    } else {
    ...
    <body>
        ...
        <table style="width:100%" id="tbl">
            <caption  class="tbl_head">
                ...
                <center class="cont_title" ><?PHP echo 'INVENTARIO DE PRODUCTO PERCHA INCONFORME' ?></center>
