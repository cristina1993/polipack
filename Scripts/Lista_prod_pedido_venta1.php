                ...
                <tr>
                    ...
                    <td align="center">
                        ...
                        if ($estado == 'Aprobado') {
                            ...
                            if ($estado != 'Facturado' && $estado != 'Programado' && $prod[emp_id]!=1 ) {
                                if ($Prt->edition == 0) {
                                    ?>
                                    <img src="../img/upd.png" width="20px" title="Generar Orden" class="auxBtn" onclick="auxWindow(1,<?php echo $rst[det_id] ?>,<?php echo $prod[emp_id] ?>)">
                                    <?php
                                }
                            }
                        }
